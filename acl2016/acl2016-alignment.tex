...
% In particular, does it results from priming of individual lexical items, priming of more complex syntactic or conceptual categories, or higher-level discourse and communicative processes. BUilding on
% . While many computational measures have been developed for assessing alignment, most are not suitable for
% they have not delved into the different components of linguistic alignment.
